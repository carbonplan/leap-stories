...
Climate change is driven by greenhouse gas emissions, and future warming will be determined by how much humans choose to emit. But warming would be worse today if not for the natural processes that pull carbon out of the atmosphere and store it. Natural carbon sinks on land and in the oceans are critical for understanding and mitigating climate change, and they’ve significantly reduced the impacts of our climate changing choices to date. For example, only half of the CO₂ humans added to the atmosphere between 2013 and 2022 remains there today – the rest is in the seas and soils.
...
But the climate service of absorbing our excess carbon does not come for free. As water absorbs CO₂, it becomes more acidic. This has [negative impacts](https://doi.org/10.1146/annurev-environ-012320-083019) on the health of many kinds of marine life, reducing the effectiveness of the biologic pump while also chemically diminishing the ability of ocean waters to absorb even more carbon.
...
<Figure title='Burning fossil fuels changes the ocean carbon cycle'>
  ...
  <FigureCaption number={2}>
    ...
    2,000 meters depth. Atmospheric CO₂ is naturally dissolved into the ocean,
    and moved from the surface to deep ocean levels via biological processes
    tied to the food web (left) and the overturning of temperature layers
    (right). As carbon concentrations in the atmosphere become higher due to
    human activity, more CO₂ is dissolved into the surface layers. Natural
    processes that store carbon in the deep ocean can’t keep up with this
    increase, resulting in more carbon remaining in the surface ocean.
  </FigureCaption>
</Figure>
