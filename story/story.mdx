...
<Figure title='Burning fossil fuels changes the natural ocean carbon cycle'>
  ...
  <FigureCaption number={2}>
    ...
    2,000 meters depth. On the left, you can see globally-averaged data for
    carbon concentrations compared to ocean depth. This distribution of carbon
    in the water changes depending on whether you’re looking at “natural”
    background levels of CO₂ , “human-derived” levels added by burning fossil
    fuels, or the combination of both. On the right, you can see how the natural
    processes that move carbon from the atmosphere to the deep ocean work, and
    how they change as more human-derived carbon is added to the system. As
    human activity introduces higher levels of CO₂ to the surface layers,
    natural processes that store carbon in the deep ocean can’t keep up. The
    result is more carbon remaining at the surface layer.
  </FigureCaption>
</Figure>
...
<Figure title='How scientists build global estimates from limited measurements'>
  ...
  <FigureCaption number={3}>
    ...
    number of places. So scientists apply machine learning to combine these
    sparse data with other full-coverage datasets, such as sea surface
