...
There are several interconnected processes, all happening in the ocean at once, that affect how carbon is taken up and stored in the water. Ocean waters warm when they rise to the surface in the tropical ocean and then cool and fall into deeper levels as they move toward the pole. CO₂ dissolves in seawater, and cold seawater can hold more CO₂ than warm water, so waters that are cooling tend to take up carbon, and waters that are warming tend to emit carbon. That means the overturning layers of warm and cold water moving around the globe affect the pattern of how CO₂ moves between the sea and air.

The ocean is teeming with plant life, which also has an impact on the carbon sink. Those plants use carbon extracted from seawater to grow. Much of this organic matter is quickly recycled back into dissolved carbon at the surface ocean as plants and animals consume each other. But a small portion (\<1%) of the waste matter sinks down to depth and enriches the abyss with carbon (Figure 2). This process – called the biological pump, moves carbon from the atmosphere into the surface ocean, and then transports it to the deep ocean, ultimately moving carbon out of the atmosphere.

Meanwhile, as humans increase the atmospheric CO₂ concentration, more carbon is driven into the oceans (Figure 2, “human derived”). This happens because the gas in the air and the gas dissolved in the water will naturally come to an equilibrium in a process known as [Henry's Law](https://en.wikipedia.org/wiki/Henry%27s_law). Human-derived carbon is almost all in the surface ocean and slowly penetrates to depth with the long timescale of the ocean overturning circulation (~1000 years). The vast majority of the carbon in the ocean has accumulated there due to natural processes and is at highest concentrations in the deep ocean.

But the climate service of absorbing our excess carbon does not come for free. As water absorbs CO₂, it becomes more acidic. This has [negative impacts](https://doi.org/10.1146/annurev-environ-012320-083019) on the health of many kinds of marine life, potentially reducing the effectiveness of the biological pump. Acidification also chemically diminishes the ability of ocean waters to absorb even more carbon.

<Figure title='Burning fossil fuels changes the natural ocean carbon cycle'>
  <OceanCycleDiagram />
  <FigureCaption number={2}>
    The [ocean carbon cycle](https://doi.org/10.1029/2021rg000736), surface to
    2,000 meters depth. Globally-averaged data (left) for the large background
    (natural), the human-derived perturbation, and the sum of these (“all”). The
    key processes (right) are (i) Atmospheric CO₂ is naturally dissolved into
    the ocean, and moved from the surface to deep ocean levels via (ii)
    biological processes tied to the food web and (iii) the overturning
    circulation . As carbon concentrations in the atmosphere become higher due
    to human activity, more CO₂ is dissolved into the surface layers. Natural
    processes that store carbon in the deep ocean can’t keep up with this
    increase, resulting in more human-derived carbon remaining in the surface
    ocean (shown at left).
  </FigureCaption>
</Figure>
...
<Figure title='How scientists build global estimates from limited measurements'>
  <FCO2Maps />
  <FigureCaption number={3}>
    Carbon concentrations in seawater can only be directly measured in a limited
    number of places. Machine learning is applied to combine these sparse data
    with other full-coverage datasets, such as sea surface temperatures, to
    reconstruct full-coverage estimates of surface ocean concentrations over
    time.
  </FigureCaption>
</Figure>

Despite decades of coordinated international efforts by ocean carbon scientists, fCO₂ observations are available for only a small fraction of the vast global ocean (~2% coverage) – predominantly in the northern hemisphere and along common shipping routes. How do we understand the global ocean carbon sink where we do not have truly global data? Machine learning applied to use full-coverage observations of related variables (for example, sea surface temperature collected from satellites) to build full-coverage fCO₂ maps from these sparse data. From fCO₂, air-sea CO₂ fluxes can be calculated.
