...
<Map
  sourceUrl='https://carbonplan-data-viewer.s3.us-west-2.amazonaws.com/demo/leap-data-stories/GCB-2023_dataprod_LDEO-HPD_1959-2022-aggregated-yearly.zarr'
  variable='sfco2'
  clim={[280, 440]}
  colormapName='warm'
/>
...
<Map
  sourceUrl='https://carbonplan-data-viewer.s3.us-west-2.amazonaws.com/demo/leap-data-stories/SOCATv2019_tracks_gridded_aggregated-yearly.zarr'
...
<Map
  sourceUrl='https://carbonplan-data-viewer.s3.us-west-2.amazonaws.com/demo/leap-data-stories/SOCATv2019_tracks_gridded_yearly.zarr'
  variable='fco2_ave_weighted_year'
  clim={[280, 440]}
  colormapName='warm'
/>
