...
Figure 1: Animation of globally-summed CO2 sources and sinks (Gigatons of Carbon, GtC). From left to right, cumulative emissions of CO2 from 1850 to the year indicated at middle of (1) carbon from fossil fuels (gray) and (2) land use change (orange); net absorption into (3) land plants and soils (light green) and (4) into the ocean (dark green); and (5) the remaining carbon that has accumulated in the atmosphere (blue). Sources indicated with upward arrows, sinks with downward arrows. Data from

This bar plot as animation
...
Figure 4: animation of 2 maps: global map of fCO2 progressing in time and next to it a global map of mean carbon flux (mol/m2/yr).
...
Figure 4: Bathtub analogy (interactive with slider for flow)
